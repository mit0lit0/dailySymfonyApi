    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/login')) {
            ...
            if ('/login' === $pathinfo) {
                if ('GET' !== $canonicalMethod) {
                    $allow[] = 'GET';
                    goto not_app_login_get;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\LoginController::getAction',  '_route' => 'app_login_get',);
            }
            not_app_login_get:

            // app_login_id
            if (preg_match('#^/login/(?P<coduser>[^/]++)$#s', $pathinfo, $matches)) {
                if ('GET' !== $canonicalMethod) {
                    $allow[] = 'GET';
                    goto not_app_login_id;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_login_id')), array (  '_controller' => 'AppBundle\\Controller\\LoginController::idAction',));
            }
            not_app_login_id:
